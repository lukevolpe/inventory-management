        ...
        <div className="hidden md:flex justify-between items-center gap-5">
          <div>
            <button onClick={toggleDarkMode}>
              {isDarkMode ? (
                <Sun className="cursor-pointer text-gray-500 size-6" />
              ) : (
                <Moon className="cursor-pointer text-gray-500 size-6" />
              )}
            </button>
          </div>
          <div className="relative">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <Image
              src="https://s3-inventorymanagement-bucket-lv.s3.eu-west-2.amazonaws.com/profile.webp"
              alt="Profile"
              width={50}
              height={50}
